...
import {faGauge,faBookOpen,faCalendar, faUserGraduate, faChalkboardTeacher, faBook, faListCheck,faPersonChalkboard} from '@fortawesome/free-solid-svg-icons';
    ...
    <div className='w-72 pt-20 h-screen fixed left-0 bg-white z-10'>
        <div className="flex flex-col gap-4 p-4 font-medium text-sm text-slate-600 h-full overflow-y-auto" id={styles.noScrollBar}>
          ...
          <div className='border-b p-2'>
            ...
            <div className='mb-1'>
              <div className="flex gap-2 item-center w-full hover:bg-[#ede7f6] hover:text-[#673ab7] rounded-lg cursor-pointer p-3 pl-6" onClick={showCurriculum}>
              ...
              <div className="flex flex-col px-6 text-sm mt-1 font-normal" style={{display:displayCurriculum}}>
                 <Link href="/user/counsellor/curriculum/curriculumLibrary"><li className='cursor-pointer px-3 py-1.5 rounded-lg hover:text-[#673ab7] hover:font-semibold'>Curriculum Library</li></Link>
                 ...
                 <Link href="/user/counsellor/curriculum/activities"><li className='cursor-pointer px-3 py-1.5 rounded-lg hover:text-[#673ab7] hover:font-semibold'>Activites</li></Link>
              </div>
            </div>

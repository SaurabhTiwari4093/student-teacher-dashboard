...
import {faImage, faPlusCircle, faToggleOff, faToggleOn, faUpload} from '@fortawesome/free-solid-svg-icons';
...
export default function AddActivity(props) {
  ...
  return (
    <div className="w-full grid grid-cols-5 h-screen fixed right-0 top-0 z-30 text-slate-800 overflow-y-auto">
        <div className="bg-opacity-50 col-span-1 bg-black">
        </div>
        <div className="col-span-4 bg-white">
            <div className="bg-[#e3f2fd] fixed top-0 w-full p-4 md:p-6 flex items-center justify-start gap-4 md:gap-6">
                ...
                <div className="text-center font-bold text-base md:text-xl">Add New Activity</div>
            </div>
            <div className="p-4 pt-24 md:p-6 md:pt-24">
              ...
              <div className="grid grid-cols-4 gap-4 md:gap-6">
                  ...
                  <div className="col-span-4 font-semibold">
                    <label>Description
                      <textarea className="w-full p-2 border border-slate-200 rounded-lg outline-none" rows="5"/>
                    </label>
                  </div>
                  ...
                  <div className="col-span-4 rounded-lg bg-[#f6f7f8] p-4 md:p-6 grid grid-cols-2 gap-4 md:gap-6 font-semibold">
                    <div className="col-span-1">
                      <label className="w-full py-0.5 px-3 border border-slate-200 rounded-lg outline-none text-slate-600 mt-6 bg-white flex items-center justify-between">
                        ...
                        <div className="text-[#673ab7] text-3xl cursor-pointer" onClick={onToggleButtonTwo}>
                          {toggleTwoOn?<FontAwesomeIcon icon={faToggleOn}/>:<FontAwesomeIcon icon={faToggleOff}/>}
                        </div>
                      </label>
                    </div>
                    <div className="col-span-1">
                    ...
                    <label>Upload Activity
                      <div className="bg-[#f6f7f8] p-4 md:p-6 grid grid-cols-5 rounded-lg">
                        ...
                        <div className="col-span-4 flex flex-col gap-3">
                          <div className="text-xs md:text-sm">Drag and drop one or more files here or select a file from your computer</div>
                          <div><button className="py-2 px-3 text-sm rounded-lg bg-[#673ab7] hover:bg-[#563199] text-white"><FontAwesomeIcon icon={faUpload}/>{" "}Upload</button></div>
                        </div>
                      </div>
                    </label>
              ...
              <div className="font-semibold my-4 md:my-6">
                  <div className="flex justify-between items-end gap-4 md:gap-6">
                    <div className="w-full">
                      <label>Triggers{" ("}You can add multiple{" )"}
                          <input type="text" placeholder="" className="w-full p-2 border border-slate-200 rounded-lg outline-none text-slate-600"/>
                      </label>
                    </div>
                      <div>
                          <button className="py-2.5 px-3 text-sm rounded-lg bg-[#673ab7] hover:bg-[#563199] text-white my-0.5"><FontAwesomeIcon icon={faPlusCircle}/></button>
                      </div>
                  </div>
                  <div className="text-xs md:text-sm text-slate-500 my-3 font-normal flex flex-col gap-2">
                      <div className="bg-[#f6f7f8] py-2 px-3 flex justify-between rounded-lg">
                        <div>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Sit dolores architecto, voluptate commodi.</div>
                        <div>X</div>
                      </div>
                      <div className="bg-[#f6f7f8] py-2 px-3 flex justify-between rounded-lg">
                        <div>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Sit dolores architecto.</div>
                        <div>X</div>
                      </div>
                  </div>
              </div>
              ...
              <div className="font-semibold my-4 md:my-6">
                  <div className="flex justify-between items-end gap-4 md:gap-6">
                    <div className="w-full">
                      <label>Learning Outcomes{" ("}You can add multiple{" )"}
                          <input type="text" placeholder="" className="w-full p-2 border border-slate-200 rounded-lg outline-none text-slate-600"/>
                      </label>
                    </div>
                      <div>
              ...
              <div className="font-semibold my-4 md:my-6 gap-4 md:gap-6">
                  <label>Additional Information
                      <textarea type="text" placeholder="" className="w-full p-2 border border-slate-200 rounded-lg outline-none text-slate-600" rows="5"/>
                  </label>
              </div>
              <div className="my-4 md:my-6 grid grid-cols-2 gap-4 md:gap-6 font-semibold">
                ...
                <div className="col-span-1">
                  <label>Best Case Show Case Video
                    <div className="bg-[#f6f7f8] p-4 md:p-6 grid grid-cols-5 gap-3 rounded-lg">
                        <div className="col-span-1 flex justify-center items-center">
                            <div className="p-3 px-4 bg-white rounded-full w-fit text-2xl shadow">
                              <FontAwesomeIcon icon={faUpload}/>
              ...
              <div className="flex justify-end"><button className="py-2 px-6 rounded-lg bg-[#673ab7] hover:bg-[#563199] text-white">Submit</button></div>
            </div>
        </div>
    </div>
  );

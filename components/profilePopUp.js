  ...
  return (
    ...
    <div className='absolute right-5 md:right-7 top-[4.6rem] bg-[white] shadow-xl rounded-lg p-4 md:p-6 z-30 w-5/6 md:w-1/5 text-slate-800'>
        ...
        <div className="flex flex-col gap-2 mt-3 text-slate-500 font-medium text-sm">
            <div className='px-2'>
                <div className="flex gap-2 item-center w-full hover:bg-[#ede7f6] hover:text-[#673ab7] rounded-lg p-3 pl-6 cursor-pointer" onClick={viewProfile}>
    ...
    <div style={{display:showViewProfile}}>
        <ViewProfile showViewProfile={showViewProfile} setShowViewProfile={setShowViewProfile}/>
    </div>
    </>
  )
}

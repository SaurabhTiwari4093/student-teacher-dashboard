        ...
        <div className="min-h-screen text-slate-800 grid grid-cols-3">
          ...
          <div className="col-span-3 md:col-span-2 flex justify-center items-center h-full p-4 md:p-6 text-center">
            <div className="w-4/5 md:w-2/5">
                ...
                <div className="text-[#673ab7] font-bold text-2xl my-4">{user==="Counsellor"?"Operation Team":user} Login</div>
                ...
                <div><button className="w-full py-2 text-white bg-[#673ab7] rounded font-medium my-4 hover:bg-[#563199]" onClick={userLogin}>Login</button></div>
            </div>
          </div>
        </div>
    </>

...
const dataPie = {
  ...
  datasets: [
    {
      data: [12, 19, 15],
      backgroundColor: ["#243f94", "#ed4d51", "#43C272"],
      borderWidth: 1,
    },
  ],
};
...
export default function Dashboard() {
  ...
  return (
    <>
      ...
      >
        <div
          className="bg-[#e3f2fd] h-full rounded-t-lg p-4 md:p-6 overflow-y-auto no-scroll-bar"
        >
          <div className="bg-white rounded-lg border border-[#bee1fa]">
            <div className="p-4 md:p-6 border-b flex gap-3 items-center">
              <div>
                <div className="font-semibold text-xl md:text-2xl">
                  <span className="text-slate-500">Hello</span>, Admin
                </div>
                <div className="font-base text-slate-500 text-normal">
                  Welcome back!
                </div>
              </div>
              <div className="text-4xl flex items-center text-yellow-500">
            ...
            <div className="p-4 md:p-6 grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
              <div className="col-span-2 grid grid-cols-4 gap-4 md:gap-6">
                ...
                <div className="col-span-4 md:col-span-2 flex flex-col gap-4 md:gap-6">
                  <div className="col-span-4 md:col-span-2 p-4 md:p-6 rounded-lg border flex gap-4 relative">
                    <div className="text-2xl md:text-3xl p-1 text-sky-600">
                      <FontAwesomeIcon icon={faUserGraduate} />
                    </div>
                    <div className="flex flex-col gap-2">
                      <div className="text-3xl md:text-4xl font-bold">211</div>
                      <div className="text-slate-400 text-base md:text-lg pb-4">
                        Students
                      </div>
                    </div>
                    <Link href="/user/admin/student/studentList">
                      <div className="absolute bottom-3 right-3 text-xs md:text-sm text-[#673ab7] font-medium cursor-pointer">
                        See More {">"}
                      </div>
                    </Link>
                  </div>
                  <div className="col-span-4 md:col-span-2 p-4 md:p-6 rounded-lg border flex gap-4 relative">
                    <div className="text-2xl md:text-3xl p-1 text-orange-600">
                ...
                <div className="col-span-4 md:col-span-2 rounded-lg border p-4 md:p-6 relative">
                  <div>
                    <div className="font-semibold text-base md:text-lg text-slate-800 mb-4">
                      Classes
                    </div>
                    <div>
                      <Bar
              ...
              <div className="col-span-2 md:col-span-1 p-4 md:p-6 bg-[#f6f7f8] rounded-lg relative">
                ...
                <div className="absolute bottom-3 right-3 text-xs md:text-sm text-[#673ab7] font-medium">
                  See More {">"}
                </div>
              </div>
            </div>
